 ...
 *
 */
public class getPastBookingsTask extends Task<ArrayList<Booking>> {
    private User loggedInUser;

    public getPastBookingsTask(User loggedInUser){
        this.loggedInUser = loggedInUser;
    }
    protected ArrayList<Booking> call(){
        MysqlUtil util = new MysqlUtil();
        ArrayList<Booking> res = util.getPastBookings(loggedInUser);
