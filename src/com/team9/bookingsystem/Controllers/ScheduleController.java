...
public class ScheduleController {
    ...
    public void init(MainController mainController,ScheduledObject toShow,User loggedInUser){

        if(toShow.getType() == "Room"){
            room = (Room)toShow;
        }
        else if(toShow.getType() == "User"){
            user = (User)toShow;
        }
    ...
    private void setupAgenda(){
        ...
        if(room != null){
            ...
            ArrayList<BookedRoom> bookings= util.getBookings(room);
        ...
        for(BookedRoom bookedRoom : bookings){
            ...
            User appointmentUser = util.getUserFromId(bookedRoom.getUserID());
            ...
            String startTime = bookedRoom.getStartTime();
            ...
            String endTime = bookedRoom.getEndTime();
